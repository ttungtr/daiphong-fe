...
export const FieldsSection: FunctionComponent = () => {
    ...
    <div className='w-full py-4 md:py-4 lg:py-8 bg-white'>
      <div className='max-w-7xl flex flex-col items-center justify-center mx-auto px-4 sm:px-6 lg:px-8'>
        ...
        <p className='text-center max-w-[90%] sm:max-w-[80%] text-black/80 text-sm sm:text-base mb-6 md:mb-8'>
          Tiêu chí kinh doanh hàng đầu của chúng tôi là cung cấp dịch vụ tốt
          nhất, cung cấp giải pháp tối ưu cho khách hàng và đảm bảo hoàn thành
          dự án theo đúng ý tưởng thiết kế, chất lượng và tiến độ đã đề ra.
        </p>
        ...
        <div className='group relative w-full overflow-hidden pb-12'>
          <Swiper
            ...
            navigation={{
              nextEl: '.fields-swiper-button-next',
              prevEl: '.fields-swiper-button-prev',
            }}
            pagination={{
              clickable: true,
              el: '.fields-swiper-pagination',
            ...
            className='w-full'
          >
            {servicesData.slice(0, 6).map((field) => (
        ...
        <div className='w-full flex items-center justify-center py-3 mt-6 md:mt-8'>
          <Link
            ...
            className='bg-primary-blue-1 hover:opacity-70 text-white duration-300 w-32 sm:w-40 text-center py-2 rounded-md text-sm font-semibold transition-colors'
          >
