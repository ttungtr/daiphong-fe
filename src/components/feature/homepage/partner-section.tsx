        ...
        <div className="lg:col-span-1 flex flex-col items-center justify-center">
          <div className="space-y-2 sm:space-y-4 w-full">
            ...
            <p className="text-justify text-sm sm:text-base mb-1">
              <strong>Đại Phong</strong> tự hào là thành viên của một mạng lưới
              đối tác chiến lược rộng lớn, bao gồm các tập đoàn, doanh nghiệp
              hàng đầu trong nhiều lĩnh vực. Sự hợp tác bền vững với hơn 50 đối
              tác uy tín đã giúp chúng tôi mở rộng phạm vi hoạt động và nâng cao
