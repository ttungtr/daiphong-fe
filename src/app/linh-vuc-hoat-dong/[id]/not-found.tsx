    ...
    <div className="min-h-screen flex items-center justify-center px-4">
      <div className="text-center">
        ...
        <p className="text-base lg:text-lg text-gray-600 mb-8">
          Dịch vụ bạn tìm kiếm không tồn tại hoặc đã được chuyển đổi.
        </p>
        <div className="space-x-4">
          <Link
            href="/linh-vuc-hoat-dong"
            className="text-sm lg:text-base bg-primary-blue-1 text-white px-6 py-3 rounded-lg hover:bg-primary-blue-1 transition-colors"
          >
            Xem tất cả dịch vụ
          </Link>
          <Link
